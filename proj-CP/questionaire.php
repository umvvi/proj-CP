...
<body>
    <?php
        ...
        //6:klik dan op "nieuw", 7:noem de database: Project-P3, 8:noem de tabelnaam "Questionaire" en maak 2 kolommen,
        ...
        //11:derde kolom: "naam: e-mail" ; "type: varchar" ; "lengte: 100" ; "standaardwaarde: geen" ; "collatie: geen" ; "attributen: geen"
